  ...
  return (
    <>
      ...
      <main className="container text-center mt-5">
        ...
        />
        <h1 className="mt-5 display-5">O QUE É?</h1>
        <p className="lead mx-auto" style={{ maxWidth: '1000px' }}>
      ...
      <section className="container d-flex flex-wrap justify-content-center gap-4 mb-5">
        ...
        <a href="/ensino" className="text-decoration-none text-dark">
          <div className="card shadow card-custom d-flex align-items-center justify-content-center p-3 mt-5">
            <h2>ENSINO</h2>
            <p className="mt-3 text-center">
      ...
      <section className="container my-5 px-3">
        <div className="text-start mb-4">
          <h1 className="display-6">UMA HISTÓRIA</h1>
        ...
        <div className="text-end">
          <h1 className="display-6">DE CONQUISTA</h1>
          <p className="lead" style={{ maxWidth: '75%', marginLeft: 'auto' }}>
